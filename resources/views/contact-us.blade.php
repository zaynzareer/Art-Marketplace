    ...
    <div class="grid md:grid-cols-2 gap-12 items-start">
      ...
      <div class="bg-white border border-gray-100 rounded-lg shadow-sm p-8">
        ...
        <form action="{{ route('contact.send') }}" method="POST" class="space-y-6">
          ...
          <!-- Submit -->
          <button type="submit"
            class="px-6 py-2.5 bg-indigo-600 text-white font-semibold rounded-lg hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition duration-200">
            Send Message
          </button>
        </form>
      </div>
